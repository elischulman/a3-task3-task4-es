...
# apply trend line
  ...
  labs(title = "Purple Urchin Decline 2008-2020",
       ...
       color = "Site",
       caption = "Purple Urchin observations at every site in the study have declined since 2008. Kelp treatment at the sites may have an impact on observed population sizes.") +
  theme_minimal() +
# center plot title
  theme(plot.title = element_text(hjust = .5)) 
```
