...
#### Interpretation: The sample s are normally distributed, and exhibit a slight positive skew. Additionaly, there are more samples taken from the area which had annual kelp removal than from the control group. We cannot tell, from these graphics, whether removing the giant kelp each winter (ANNUAL treatment) results in smaller purple urchins at Naples Reef.
...
kable(urchins_purp_stats, 
      col.names = c('Sampling Group', 'Sample Size', 'Mean (cm)', 'Smallest (cm)', 'Largest (cm)', 'Standard Deviation (cm)'),
